...
public class ItemCouponBindingImpl extends ItemCouponBinding  {
    ...
    private ItemCouponBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.couponeTextView.setTag(null);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.boostcamp.shoppingapp.model.Coupon) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.boostcamp.shoppingapp.model.Coupon Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.boostcamp.shoppingapp.model.Coupon item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.couponeTextView, itemCoupon);
