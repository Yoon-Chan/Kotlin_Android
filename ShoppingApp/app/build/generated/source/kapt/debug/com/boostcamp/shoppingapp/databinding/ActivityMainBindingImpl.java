...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.logoImageView, 3);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.boostcamp.shoppingapp.MainViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.boostcamp.shoppingapp.MainViewModel Item) {
        this.mItem = Item;
    }
