...
import com.boostcamp.shoppingapp.di.MainRepositoryModule_ProvidesMainRepositoryFactory;
import com.boostcamp.shoppingapp.di.MainServiceModule;
import com.boostcamp.shoppingapp.di.MainServiceModule_ProvidesMainServiceFactory;
import com.boostcamp.shoppingapp.di.RetrofitModule;
import com.boostcamp.shoppingapp.di.RetrofitModule_ProvidesConverterFactoryFactory;
import com.boostcamp.shoppingapp.di.RetrofitModule_ProvidesOkHttpClientFactory;
import com.boostcamp.shoppingapp.di.RetrofitModule_ProvidesRetrofitFactory;
...
public final class DaggerHiltApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends HiltApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.boostcamp.shoppingapp.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.boostcamp.shoppingapp.MainViewModel 
          return (T) new MainViewModel(viewModelCImpl.providesMainRepositoryProvider.get());

          case 1: // com.boostcamp.shoppingapp.remote.repository.MainRepository 
          return (T) MainRepositoryModule_ProvidesMainRepositoryFactory.providesMainRepository(singletonCImpl.providesMainServiceProvider.get());
  ...
  private static final class SingletonCImpl extends HiltApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.boostcamp.shoppingapp.remote.MainService 
